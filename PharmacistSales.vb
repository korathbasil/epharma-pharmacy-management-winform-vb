...
Public Class PharmacistSales
    ...
    Private Sub CheckoutBill()
        ...
        Else
            ...
            SalesModule.CheckoutSale(Total)
            PrintBill()
            ResetForm()
            BillView.Rows.Clear()
            Total = 0
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        Dim FBoldBig As New Font("Calibri", 12, FontStyle.Bold)
        ...
        e.Graphics.DrawString("ePharma", FBoldBig, Brushes.Black, CenterMargin, 10, CenterAlign)
        e.Graphics.DrawString("Invoice", FNormal, Brushes.Black, CenterMargin, 25, CenterAlign)
